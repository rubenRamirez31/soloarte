    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="Images/CB1.jpg" class="d-block w-100" alt="imagen">
        </div>
        <div class="carousel-item">
          <img src="Images/CB2.jpg" class="d-block w-100" alt="imagen">
        </div>
        <div class="carousel-item">
          <img src="Images/CB3.jpg" class="d-block w-100" alt="imagen">
        </div>
      </div>
